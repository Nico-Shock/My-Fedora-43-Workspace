...
run_with_progress 8 sudo dnf install -y plasma-desktop konsole ark sddm
run_with_progress 2 sudo systemctl enable sddm
...
echo "    • Configure KDE themes in System Settings"
echo "    • Install Klassy theme for window decorations"
